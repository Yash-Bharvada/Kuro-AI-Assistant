...
export function KuroCommandDock({
    ...
    return (
        ...
        >
            ...
            {/* Command Dock */}
            <div className="bg-zinc-900/40 backdrop-blur-xl border border-white/10 rounded-full px-8 py-5 flex items-center gap-3 w-[700px] shadow-2xl shadow-black/50">
                <input
                    value={inputValue}
                    onChange={(e) => setInputValue(e.target.value)}
                    onKeyDown={handleKeyDown}
                    placeholder='Ask Kuro anything...'
                    className="flex-1 bg-transparent outline-none text-white placeholder-zinc-500 font-medium text-xl"
